...
import "../../../../holyzeppelin/contracts/token/ERC20/SafeERC20.sol";
...
contracts ERC20StepModule {
  ...
  /**
    ...
    */
  function name( address tokenForName_ ) public view returns (string memory) {
      return IERC20(tokenForName_).name();
  }
